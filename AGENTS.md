...
restating them. Two more from the same plugin apply to how any task here gets branched and
scoped: **`foundations:branch-naming`** — every branch follows `<type>/<slug>`
