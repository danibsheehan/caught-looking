  ...
  it('uses the latest tied peak for short datasets', async () => {
    api.fetchRecordTimeline.mockResolvedValueOnce(
      record([
        ...
        { gameIndex: 3, officialDate: '2026-04-03', result: 'W', wins: 2, losses: 1, pct: 0.667 },
        { gameIndex: 4, officialDate: '2026-04-04', result: 'L', wins: 2, losses: 2, pct: 0.5 },
        { gameIndex: 5, officialDate: '2026-04-05', result: 'L', wins: 3, losses: 2, pct: 0.6 },
        { gameIndex: 6, officialDate: '2026-04-06', result: 'W', wins: 4, losses: 2, pct: 0.667 },
      ]),
    )
