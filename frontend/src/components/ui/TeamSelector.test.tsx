...
describe('TeamSelector', () => {
  ...
  it('associates label with select via id and htmlFor', () => {
    render(
      <TeamSelector id="my-team" label="Pick club" teams={teams} value="" onChange={vi.fn()} />,
    );
  ...
  it('sorts options by abbreviation', () => {
    render(<TeamSelector teams={teams} value="" onChange={vi.fn()} />);
  ...
  it('reflects controlled value', () => {
    render(<TeamSelector teams={teams} value={2} onChange={vi.fn()} />);
