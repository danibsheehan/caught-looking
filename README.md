...
<!-- perf-metrics:start -->
Warm cache-hit p95: **4.8ms** (target < 100ms) · cold-miss latency stays flat as concurrency scales to 500 clients, proving singleflight coalescing rather than serialized upstream calls — measured 2026-09-21. Cold numbers reflect a fixture-only injected test delay, not real-world timing — see [the full sweep and methodology](docs/perf-results.md).
<!-- perf-metrics:end -->
